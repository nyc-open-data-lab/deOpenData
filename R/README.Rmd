...
[![CRAN downloads](https://cranlogs.r-pkg.org/badges/grand-total/deOpenData?color=blue)](https://r-pkg.org/pkg/deOpenData)
[![Lifecycle: stable](https://img.shields.io/badge/lifecycle-stable-brightgreen.svg)](https://lifecycle.r-lib.org/articles/stages.html)
[![Project Status: Active](https://www.repostatus.org/badges/latest/active.svg)](https://www.repostatus.org/#active)

`deOpenData` provides a lightweight R interface to the
...
Delaware Open Data Portal directly into R without manually constructing API
...
Most workflows begin with `de_list_datasets()`, which retrieves a live catalog
of datasets available through the Delaware Open Data Portal.
...
- `de_list_datasets()` retrieves a live catalog of available Delaware Open
...
Datasets retrieved through `de_pull_dataset()` support arguments including:
...
Because the package retrieves metadata dynamically from the live Delaware Open
...
`deOpenData` is an independent project and is not affiliated with, endorsed
by, or maintained by Delaware or the organization responsible for the Delaware
Open Data Portal.
